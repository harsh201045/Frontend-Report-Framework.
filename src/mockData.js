...
export const columns = [
  { Header: 'ID', accessor: 'id', type: 'integer' },
  { Header: 'Name', accessor: 'name', type: 'string' },
  { Header: 'Age', accessor: 'age', type: 'integer' },
  { Header: 'Role', accessor: 'role', type: 'enum', options: ['Engineer', 'Manager', 'Intern'] },
  { Header: 'Hire Date', accessor: 'hireDate', type: 'date' },
  { Header: 'Active', accessor: 'isActive', type: 'boolean' },
  { Header: 'Salary', accessor: 'salary', type: 'integer' },
  { Header: 'Department', accessor: 'department', type: 'string' },
  { Header: 'Projects Completed', accessor: 'projectsCompleted', type: 'integer' },
  { Header: 'Last Login', accessor: 'lastLogin', type: 'date' },
  { Header: 'Access Level', accessor: 'accessLevel', type: 'enum', options: ['Admin', 'User'] }
];